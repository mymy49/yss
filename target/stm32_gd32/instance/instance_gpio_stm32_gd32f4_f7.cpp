...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOARST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOBRST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOCRST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIODRST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOERST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOFRST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOGRST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOHRST_Pos);
	clock.unlock();
}
...
{
	clock.lock();
	clock.resetAhb1(RCC_AHB1RSTR_GPIOIRST_Pos);
	clock.unlock();
}
