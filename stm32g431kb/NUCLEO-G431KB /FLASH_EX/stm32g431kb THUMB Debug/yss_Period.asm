	...
	.text
.Ltext0:
	.section	.text._ZN6PeriodC2Ej,"ax",%progbits
	.align	1
	.global	_ZN6PeriodC2Ej
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	_ZN6PeriodC2Ej, %function
_ZN6PeriodC2Ej:
.LFB1:
	.file 1 "/home/mymy49/library/yss/yss/util/yss_Period.cpp"
	.loc 1 5 1
...
.LCFI1:
	...
	bx	lr
.LFE1:
	.size	_ZN6PeriodC2Ej, .-_ZN6PeriodC2Ej
	.global	_ZN6PeriodC1Ej
	.thumb_set _ZN6PeriodC1Ej,_ZN6PeriodC2Ej
	.section	.text._ZN6Period5resetEv,"ax",%progbits
	.align	1
	.global	_ZN6Period5resetEv
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	_ZN6Period5resetEv, %function
_ZN6Period5resetEv:
.LFB3:
	.loc 1 12 1
	@ args = 0, pretend = 0, frame = 8
...
.LCFI4:
	...
	ldr	pc, [sp], #4
.LFE3:
	.size	_ZN6Period5resetEv, .-_ZN6Period5resetEv
	.section	.text._ZN6Period4waitEv,"ax",%progbits
	.align	1
	.global	_ZN6Period4waitEv
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	_ZN6Period4waitEv, %function
_ZN6Period4waitEv:
.LFB4:
	.loc 1 17 1
...
.LCFI7:
	...
	pop	{r4, r5, pc}
.LFE4:
	.size	_ZN6Period4waitEv, .-_ZN6Period4waitEv
...
.LEFDE4:
	.text
.Letext0:
	.file 2 "/home/mymy49/library/yss/yss/inc/util/Period.h"
...
.Ldebug_abbrev0:
	...
	.4byte	0x186
	.4byte	0xd9
	.ascii	"Period::wait\000"
	.4byte	0x10f
	.ascii	"Period::reset\000"
	.4byte	0x136
	.ascii	"Period::Period\000"
	.4byte	0
...
.Ldebug_macro0:
	...
	.uleb128 0x2
	.uleb128 0x3
	.file 4 "/home/mymy49/library/yss/stm32g431kb/NUCLEO-G431KB /FLASH_EX/prj/inc/config.h"
	.byte	0x3
	.uleb128 0x16
	.uleb128 0x4
	.byte	0x7
...
.LASF551:
	.ascii	"/home/mymy49/library/yss/yss/util/yss_Period.cpp\000"
.LASF209:
