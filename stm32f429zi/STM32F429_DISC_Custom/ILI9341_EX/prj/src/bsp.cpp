...
void init(void)
{
    ...
    // SPI4 초기화
    gpioE.setToAltFunc(2, define::gpio::altfunc::SPI_AF5, define::gpio::ospeed::FAST, define::gpio::otype::PUSH_PULL); // SCK
    gpioE.setToAltFunc(5, define::gpio::altfunc::SPI_AF5, define::gpio::ospeed::FAST, define::gpio::otype::PUSH_PULL); // MOSI
    gpioE.setToAltFunc(6, define::gpio::altfunc::SPI_AF5, define::gpio::ospeed::FAST, define::gpio::otype::PUSH_PULL); // MOSI
