...
#ifndef YSS_CLASS_GPIO_MAX32665__H_
#define YSS_CLASS_GPIO_MAX32665__H_
...
#if defined(_SYSTEM_MAX32665_H_)
#include "def_gpio_max32665.h"
#endif
	...
	typedef struct
	{
		mxc_gpio_regs_t *port;    ///< Pointer to GPIO hardware register base (e.g. GPIOA, GPIOB)
	 ...
	 */
	error_t setAsOutput(uint8_t pin, outputDriveStrength_t strength = STRENGTH_MEDIUM_LOW) __attribute__((optimize("-O1")));
