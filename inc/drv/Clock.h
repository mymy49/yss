...
#include <targets/st/class_clock_stm32h7.h>
...
#if defined(STM32G4) || defined(STM32F7) || defined(STM32F4) || defined(W7500) || defined(CPU_MIMXRT1011DAE5A) || defined(__M480_FAMILY) || defined(__M43x_FAMILY) || defined(STM32H7)
