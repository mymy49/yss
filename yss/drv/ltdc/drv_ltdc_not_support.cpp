...
#if defined(YSS_DRV_LTDC_NOT_SUPPORT)
#if defined(LTDC)

#include <yss/system.h>
#include <config.h>
...
namespace drv
{
	...
	bool Ltdc::init(void){return false;}
	void Ltdc::setFrameBuffer(unsigned char *frame){}
	void Ltdc::setFrameBuffer(FrameBuffer &obj){}
	Size Ltdc::getLcdSize(void){return Size(-1, -1)}
}
