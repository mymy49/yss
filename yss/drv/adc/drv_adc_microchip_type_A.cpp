...
#include <drv/adc/drv_microchip_adc_type_A.h>

namespace drv
{
Adc::Adc(Adc_peri *peri, void (*clockFunc)(bool en), void (*nvicFunc)(bool en), void (*resetFunc)(void)) : Drv(clockFunc, nvicFunc, resetFunc)
{
    mPeri = peri;
    mIndex = 0;
    mNumOfCh = 0;
