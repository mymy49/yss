...
#ifndef	YSS_DRV_GPIO_INFINEON_TYPE_A__H_
#define	YSS_DRV_GPIO_INFINEON_TYPE_A__H_
...
#include "drv_infineon_gpio_type_A_define.h"
#include "drv_infineon_gpio_type_A_config.h"
...
namespace drv
{
	...
	{
		XMC_GPIO_PORT_t *mPeri;
		unsigned char mExti;

	public :
		Gpio(XMC_GPIO_PORT_t *peri, void (*clockFunc)(bool en), void (*nvicFunc)(bool en));
