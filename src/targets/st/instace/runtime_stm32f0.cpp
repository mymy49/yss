...
#error "RUNTIME_TIM2은 사용이 불가능합니다."
...
#error "RUNTIME_TIM4은 사용이 불가능합니다."
#elif YSS_TIMER == RUNTIME_TIM5
#error "RUNTIME_TIM5은 사용이 불가능합니다."
...
#error "RUNTIME_TIM9은 사용이 불가능합니다."
#elif YSS_TIMER == RUNTIME_TIM10
#error "RUNTIME_TIM10은 사용이 불가능합니다."
#elif YSS_TIMER == RUNTIME_TIM11
#error "RUNTIME_TIM11은 사용이 불가능합니다."
#elif YSS_TIMER == RUNTIME_TIM12
#error "RUNTIME_TIM12은 사용이 불가능합니다."
#elif YSS_TIMER == RUNTIME_TIM13
#error "RUNTIME_TIM13은 사용이 불가능합니다."
#elif YSS_TIMER == RUNTIME_TIM14
#define ISR_RUNTIME		TIM14_IRQHandler
#define RUNTIME_DEV		TIM14
#define RUNTIME_IRQ		TIM14_IRQn
#define RUNTIME_CLK_APB1
#define RUNTIME_RCC_ENR	RCC->APB1ENR
#define RUNTIME_ENR_MSK	RCC_APB1ENR_TIM14EN_Msk
#define TOP				0xFFFF
#elif YSS_TIMER == RUNTIME_TIM15
#define ISR_RUNTIME		TIM15_IRQHandler
#define RUNTIME_DEV		TIM15
#define RUNTIME_IRQ		TIM15_IRQn
#define RUNTIME_CLK_APB2
#define RUNTIME_RCC_ENR	RCC->APB2ENR
#define RUNTIME_ENR_MSK	RCC_APB2ENR_TIM15EN_Msk
#define TOP				0xFFFF
#elif YSS_TIMER == RUNTIME_TIM16
#define ISR_RUNTIME		TIM16_IRQHandler
#define RUNTIME_DEV		TIM16
#define RUNTIME_IRQ		TIM16_IRQn
#define RUNTIME_CLK_APB2
#define RUNTIME_RCC_ENR	RCC->APB2ENR
#define RUNTIME_ENR_MSK	RCC_APB2ENR_TIM16EN_Msk
#define TOP				0xFFFF
#elif YSS_TIMER == RUNTIME_TIM17
#define ISR_RUNTIME		TIM17_IRQHandler
#define RUNTIME_DEV		TIM17
#define RUNTIME_IRQ		TIM17_IRQn
#define RUNTIME_CLK_APB2
#define RUNTIME_RCC_ENR	RCC->APB2ENR
#define RUNTIME_ENR_MSK	RCC_APB2ENR_TIM17EN_Msk
#define TOP				0xFFFF
#endif
#endif
