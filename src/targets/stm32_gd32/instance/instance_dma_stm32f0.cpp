...
extern "C"
{
	...
	{
		if(DMA1[DMA_REG::ISR] & (DMA_ISR_GIF2_Msk | DMA_ISR_TCIF2_Msk | DMA_ISR_HTIF2_Msk | DMA_ISR_TEIF2_Msk))
			dmaChannel2.isr();

		if(DMA1[DMA_REG::ISR] & (DMA_ISR_GIF3_Msk | DMA_ISR_TCIF3_Msk | DMA_ISR_HTIF3_Msk | DMA_ISR_TEIF3_Msk))
			dmaChannel3.isr();
	}
}
...
extern "C"
{
	...
	{
		if(DMA1[DMA_REG::ISR] & (DMA_ISR_GIF4_Msk | DMA_ISR_TCIF4_Msk | DMA_ISR_HTIF4_Msk | DMA_ISR_TEIF4_Msk))
			dmaChannel4.isr();

		if(DMA1[DMA_REG::ISR] & (DMA_ISR_GIF5_Msk | DMA_ISR_TCIF5_Msk | DMA_ISR_HTIF5_Msk | DMA_ISR_TEIF5_Msk))
			dmaChannel5.isr();
	}
}
