...
void fill(Argb1555 &obj, Color color)
{
	...
	Dma2d::FillConfig config = 
	{
		...
		color.getArgb1555Code(),	//uint32_t color;
		colorMode::ARGB1555,		//uint8_t colorMode;
...
uint8_t drawChar(Argb1555 &des, Font *font, uint32_t utf8, Position pos, Color color)
{
	...
	Dma2d::DrawCharConfig config = 
	{
		...
		colorMode::ARGB1555,	//uint8_t destinationColorMode;
